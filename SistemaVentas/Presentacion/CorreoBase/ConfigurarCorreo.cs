...
namespace SistemaVentas.Presentacion.CorreoBase
{
    public partial class ConfigurarCorreo : Form
    {
        ...
        {
            bool estado;
            estado= Bases.enviarCorreo(TXTCORREO.Text, txtpass.Text, "Sincronizacion creada Correctamente", "Sincronizacion con el Sistema",TXTCORREO.Text, "");
            if (estado ==true)
            {
                editarCorreo();
        ...
        {
            Process.Start("https://www.twitter.com/pedroveloper");
        }
    }
}
