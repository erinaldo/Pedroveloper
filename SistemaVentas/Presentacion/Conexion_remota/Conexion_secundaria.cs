...
namespace SistemaVentas.Presentacion.Conexion_remota
{
    public partial class Conexion_secundaria : Form
    {
        ...
        private void conectar_manualmente()
        {
            ...
            cadena_de_conexion = "Data Source =" + IP + ";Initial Catalog=BASEDATOS;Integrated Security=False;User Id=pruebas2020;Password=pruebas123";
            comprobar_conexion();
