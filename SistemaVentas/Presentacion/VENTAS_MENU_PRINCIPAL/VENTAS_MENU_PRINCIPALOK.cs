...
namespace SistemaVentas.Presentacion.VENTAS_MENU_PRINCIPAL
{
    public partial class VENTAS_MENU_PRINCIPALOK : Form
    {
        ...
        private double txtprecio_unitario;
        private double ImpuestoProducto;
        private double ImpuestoCategoria;
        private double DescuentoCategoria;
        private double DescuentoProducto;
        private double descuento;
        private double precio;
        private double lblStock_de_Productos;
        private double preciounitario;
        private double cantidad;
        public static double txtpantalla;
        public static double total;
        private double precioNuevo;
        private int contador_stock_detalle_de_venta;
        private int idproducto;
        private int idClienteEstandar;
        public static int idusuario_que_inicio_sesion;
        public static int idVenta;
        private int iddetalleventa;
        private int Contador;
        public static int Id_caja;
        private int idProductoSelectL;
        private int contadorVentasEspera;
        private int contadorCotizacionesEspera;
