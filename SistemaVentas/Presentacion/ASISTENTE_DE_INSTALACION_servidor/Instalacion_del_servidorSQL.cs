...
namespace SistemaVentas.Presentacion.ASISTENTE_DE_INSTALACION_servidor
{
    public partial class Instalacion_del_servidorSQL : Form
    {
        ...
        private void Reemplazar()
        {
            ...
            txtCrear_procedimientos.Text = txtCrear_procedimientos.Text.Replace("BASEDATOS", TXTbasededatos.Text);
            //********

            txtEliminarBase.Text = txtEliminarBase.Text.Replace("BASEDATOS", TXTbasededatos.Text);          
